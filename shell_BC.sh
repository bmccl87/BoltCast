...
#SBATCH --gres=gpu:1
#SBATCH --nodelist=c980,c981
#SBATCH --exclude=c314,c315
...
python BC_train.py @txt_exp.txt @txt_unet.txt --exp=$SLURM_ARRAY_TASK_ID --cpus_per_task=16 --rotation=1 --label=16_conv_reulu
