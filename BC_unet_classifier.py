...
def create_unet(args,
    ...
    print('building the static layers')
    lat = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                            dtype=tf.dtypes.float64,
                            name='lat')
    
    lon = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                            dtype=tf.dtypes.float64,
                            name='lon')

    terrain = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                                dtype=tf.dtypes.float64,
                                name='terrain')

    graupel_250 = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                                dtype=tf.dtypes.float64,
                                name='graupel_250')

    graupel_500 = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                                dtype=tf.dtypes.float64,
                                name='graupel_500')

    graupel_700 = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                                dtype=tf.dtypes.float64,
                                name='graupel_700')

    ice_250 = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                                dtype=tf.dtypes.float64,
                                name='ice_250')

    ice_500 = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                                dtype=tf.dtypes.float64,
                                name='ice_500')

    ice_700 = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                                dtype=tf.dtypes.float64,
                                name='ice_700')

    rain_250 = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                                dtype=tf.dtypes.float64,
                                name='rain_250')
    
    rain_500 = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                                dtype=tf.dtypes.float64,
                                name='rain_500')

    rain_700 = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                                dtype=tf.dtypes.float64,
                                name='rain_700')

    snow_250 = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                                dtype=tf.dtypes.float64,
                                name='snow_250')

    snow_500 = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                                dtype=tf.dtypes.float64,
                                name='snow_500')

    snow_700 = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                                dtype=tf.dtypes.float64,
                                name='snow_700')                   

    w_500 = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                                    dtype=tf.dtypes.float64,
                                    name='w_500')

    w_700 = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                                    dtype=tf.dtypes.float64,
                                    name='w_700')
    
    reflectivity = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                                    dtype=tf.dtypes.float64,
                                    name='reflectivity')
    
    lifted_index = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                                    dtype=tf.dtypes.float64,
                                    name='lifted_index')

    cape = tf.keras.Input(shape=(image_size[0],image_size[1],1),
                                    dtype=tf.dtypes.float64,
                                    name='cape')                                    
