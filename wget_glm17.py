...
glm_base_url = 'https://lightningdev.umd.edu/feng_data_sharing/213_g17_glmgrid_arch/'
glm_stor = '/scratch/bmac87/GLM/G17/'
...
for yr in yrs:
    ...
    for mo in mos:
        ...
        for i,jul_day in enumerate(jul_days):
            temp_url2 = temp_url+yr+jul_day+'/OR_GLM-L2-GLMF-M3_G17_e'+yr+mo+days[i]
            fbase1 = '/OR_GLM-L2-GLMF-M3_G17_e'+yr+mo+days[i]
                    ...
                    try:
                        if os.path.isfile(glm_stor+fbase2):
                            ...
                            if minute=='59' and hr=='23':
                                if i<len(jul_days):
                                    temp_url5 = temp_url+yr+jul_days[i+1]+'/OR_GLM-L2-GLMF-M3_G17_e'+yr+mo+days[i+1]+'000000.nc'
